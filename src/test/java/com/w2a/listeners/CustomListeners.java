...
public class CustomListeners extends Page implements ITestListener,ISuiteListener {
	...
	public void onTestFailure(ITestResult arg0) {
		...
		String logText=Utilities.screenshotName;
		test.fail("<b><font color=red>" + "Screenshot of failure" + "</font></b><br>",MediaEntityBuilder.createScreenCaptureFromPath(Utilities.screenshotName)
				.build());
	...
	public void onTestStart(ITestResult arg0) {
		...
		test = extent
				.createTest(arg0.getTestClass().getName() + "     @TestCase : " + arg0.getMethod().getMethodName());
	}
